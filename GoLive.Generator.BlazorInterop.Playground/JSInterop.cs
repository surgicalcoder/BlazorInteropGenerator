...
namespace GoLive.Generator.BlazorInterop.Playground.Client
{
    public static class JSInterop
    {
        ...
        public static async Task<T> setPageTitleAsync<T>(this IJSRuntime JSRuntime, string @title)
        {
            return await JSRuntime.InvokeAsync<T>("window.blazorInterop.setPageTitle", @title);
        }

        public static async Task<T> setPageTitleAsync<T>(this IJSRuntime JSRuntime, string @title, CancellationToken cancellationToken)
        {
            return await JSRuntime.InvokeAsync<T>("window.blazorInterop.setPageTitle", cancellationToken, @title);
        }
        ...
        public static async Task<T> datePickerAsync<T>(this IJSRuntime JSRuntime, string @id)
        {
            return await JSRuntime.InvokeAsync<T>("window.blazorInterop.datePicker", @id);
        }

        public static async Task<T> datePickerAsync<T>(this IJSRuntime JSRuntime, string @id, CancellationToken cancellationToken)
        {
            return await JSRuntime.InvokeAsync<T>("window.blazorInterop.datePicker", cancellationToken, @id);
        }
